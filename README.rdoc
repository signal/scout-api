...
An ActiveRecord-like[http://api.rubyonrails.org/classes/ActiveRecord/Base.html] library for 
interacting with Scout[http://scoutapp.com], a hosted server monitoring service. Query for metric data, manage servers, and more.
